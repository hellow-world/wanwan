 ...
 * @Last Modified time: 2018-04-25 10:24:01
 */
...
var config = {
  ...
  entry: {
    ...
    'activity/activity-publish': [
      './src/page/activity/activity-publish/index.js'
    ],
    'activity/activity-publisher': [
      './src/page/activity/activity-publisher/index.js'
    ],
    ...
    'activity/activity-signlist': [
      './src/page/activity/activity-signlist/index.js'
    ],
    //奖池设置
    ...
    'selection/selection-review': [
      './src/page/selection/selection-review/index.js'
    ],
    //广告位设置
    ...
    //1.3.2
    // 运营管理-公告
    'information/information-sel': ['./src/page/information/information-sel/index.js'],
    'information/information-add': ['./src/page/information/information-add/index.js']
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(getHtmlConfig('activity/activity-signlist',
      '活动报名情况')),
    ...
    new HtmlWebpackPlugin(getHtmlConfig('activity/activity-publisher',
      '活动发布者')),
    ...
    new HtmlWebpackPlugin(getHtmlConfig('selection/selection-review',
      '内容审核')),
    ...
    new HtmlWebpackPlugin(getHtmlConfig('information/information-sel',
      '公告列表')),
    new HtmlWebpackPlugin(getHtmlConfig('information/information-add',
      '公告添加'))
